...
function memberCard(key, role, {featured=false}={}){
  ...
  return `<article class="member-card ${featured?'featured-member':''} reveal" style="--photo-pos:${p.pos}">
    <div class="member-media">
      <img class="member-backdrop" src="${p.img}" alt="" aria-hidden="true" loading="lazy" decoding="async">
      <img class="member-photo" src="${p.img}" alt="${p.name}" loading="lazy" decoding="async">
    </div>
