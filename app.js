...
function home(){
  return `<section class="hero view-enter"><div class="shell hero-grid">
    ...
    <div class="hero-copy"><span class="kicker">SOLARA INC  /  ROBLOX GAME STUDIO</span><h1>Games shaped by<br><span class="gradient">strong identity</span></h1><p>A multidisciplinary studio creating polished Roblox experiences with a focus on progression, identity and replayable worlds.</p><div class="hero-actions">${button('Explore Games','#games')}${button('About Solara','#about','secondary')}</div></div>
  </div></section>

  <section class="section home-about"><div class="shell">
    <div class="about-preview reveal">
      <div class="about-preview-copy">
        <span class="kicker">ABOUT THE STUDIO</span>
        <h2>Roblox experiences<br><span class="gradient">made to progress</span></h2>
        <p>Solara Inc is a game studio focused on Roblox experiences, especially simulator-style games built around progression, exploration and satisfying long-term growth.</p>
      ...
      <div class="about-preview-points">
        ...
        <div><strong>ONE TEAM</strong><span>Code, art, design and production moving together.</span></div>
      </div>
    </div>
  </div></section>
  ...
  return `<section class="about-page view-enter">
    <div class="shell">
      <header class="about-hero">
        <span class="kicker">ABOUT THE STUDIO INC</span>
        <h1>A studio focused on<br><span class="gradient">Roblox experiences</span></h1>
        <p>Solara Inc is a game studio focused on building polished Roblox games with clear progression, memorable presentation and systems designed to keep every step rewarding.</p>
      ...
      <section class="about-statement reveal">
        ...
        <div>
          ...
          <h2>Simulator games with<br><span class="gradient">a distinct identity</span></h2>
          <p>We like the accessibility and progression of simulator games, but we want each Solara project to have its own world, visual identity and reason to keep moving forward.</p>
        </div>
      </section>
      ...
      <section class="about-capabilities">
        <article class="capability reveal">
          ...
          <h3>ROBLOX EXPERIENCES</h3>
          <p>Games designed specifically for Roblox, with the platform, its players and its social nature in mind.</p>
        </article>
        <article class="capability reveal">
          <span class="capability-icon">${icon('i-bolt')}</span>
          <span class="capability-number">02</span>
          <h3>PROGRESSION & SYSTEMS</h3>
          <p>Clear goals, satisfying upgrades and gameplay systems that make progression easy to understand and rewarding to continue.</p>
        </article>
        <article class="capability reveal">
          <span class="capability-icon">${icon('i-layers')}</span>
          <span class="capability-number">03</span>
          <h3>FULL PRODUCTION</h3>
          <p>Programming, UI / UX, 3D, building, VFX, animation and studio operations developed as parts of one product.</p>
        </article>
      </section>
      ...
      <section class="about-philosophy reveal">
        ...
        <div class="philosophy-copy">
          ...
          <h2>One team across<br><span class="gradient">every discipline</span></h2>
          <p>We keep every discipline close to the game. The goal is not to add more for the sake of having more — it is to make every system, interface, effect and environment feel like it belongs to the same experience.</p>
        </div>
      </section>

      <section class="about-next reveal">
        <span class="kicker">CURRENT PROJECT</span>
        <h2>Where it begins<br><span class="gradient">Anime Ascend</span></h2>
        <p>A simulator experience centered on progression, exploration and unlocking what comes next.</p>
