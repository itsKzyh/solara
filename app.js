  ...
  <section class="section home-about"><div class="shell">
    <div class="about-preview reveal">
      <div class="about-preview-copy">
        ...
        ${button('Discover The Studio','#about','secondary')}
      </div>
  ...
  return `<section class="about-page view-enter">
    <div class="shell">
      <header class="about-hero">
        ...
        <div class="about-actions">${button('Explore Games','#games')}${button('Meet The Team','#team','secondary')}</div>
      </header>
      ...
      <section class="about-capabilities">
        <article class="capability reveal">
          <span class="capability-icon">${icon('i-cube')}</span>
        ...
        <article class="capability reveal">
          <span class="capability-icon">${icon('i-bolt')}</span>
      ...
      <section class="about-next reveal">
        ...
        <div class="about-actions">${button('View Anime Ascend','#games')}${button('Join Game Server',ANIME_ASCEND_DISCORD,'secondary','i-discord')}</div>
      </section>
    </div>
  </section>`;
}
